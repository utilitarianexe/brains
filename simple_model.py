...
class SimpleModel:
    def __init__(self, voltage_decay, input_decay, starting_membrane_voltage, step_size,
        ...
        self._cells = SimpleModel._build_network(voltage_decay, input_decay,
                                                 starting_membrane_voltage,
                                                 step_size, fake_input)
    ...
    def _build_network(voltage_decay, input_decay, starting_membrane_voltage, step_size,
                       fake_input):
        ...
        # ugly
        cell_bodies = {}
        for cell_definition in cell_definitions:
            cell_body = CellBody(voltage_decay, input_decay, starting_membrane_voltage, step_size)
        ...
        for synapse_definition in synapse_definitions:
            # magic number
            synapse  = SimpleSynapse(input_decay, step_size, 0, 0.1)
        ...
        for cell_definition, cell_body in cell_bodies.items():
            if cell_definition != fake_input_location:
